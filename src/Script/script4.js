...
const API_URL = BASE_URL + '/movie/{movie_id}/external_ids'+API_KEY;
...
// funcao mostra o titulo, a imagem, o voto e o resumo
    data.forEach(movie => {
        const {title, poster_path, vote_average, overview, id, release_date,imdb_id, movie_id} = movie;
        ...
        movieEl.innerHTML = `
            ...
            <div class="movie-info">
                <h3>${imdb_id}</h3>
                <h2>Data de lançamento: ${movie_id}</h3>
            ...
            <div class="overview">
                ...
                ${overview}
                <br/> 
                <button class="know-more" id="${imdb_id}">Know More</button
            </div>
